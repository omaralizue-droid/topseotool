      ...
      <div className="flex items-center gap-2.5 sm:gap-3">
        ...
        <div>
          <div className="flex items-center gap-2 flex-wrap">
            <h1 className="text-lg sm:text-xl font-bold tracking-tight">Your Highest-Impact Opportunities</h1>
            <Badge variant="brand" className="text-[10px]">Module 7</Badge>
          </div>
          <p className="text-xs sm:text-sm text-muted-foreground">Synthesized action plans combining Technical SEO, AI Visibility, and Competitor gap findings</p>
        </div>
      </div>
